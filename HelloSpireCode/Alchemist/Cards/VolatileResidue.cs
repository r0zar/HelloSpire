...
/// nothing on its own -- same shape as <see cref="VolatileReagent"/> and the mod's one other
/// Status card, the Paladin's Geas. Left in the discard pile automatically by
