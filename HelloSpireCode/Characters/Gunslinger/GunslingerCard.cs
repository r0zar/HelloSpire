...
/// <summary>
/// Base class for Gunslinger cards. The [Pool] attribute puts every subclass into the
/// Gunslinger's card pool automatically, so individual cards never declare it.
/// Card art resolves by class name, which is unique mod-wide, so all characters
/// share the images/card_portraits tree.
/// </summary>
[Pool(typeof(GunslingerCardPool))]
