...
/// <summary>Deal 10. Judge ×3. The triple verdict.</summary>
public sealed class GreaterJudgment() : PaladinCard(2, CardType.Attack, CardRarity.Rare, TargetType.AnyEnemy)
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await Seals.Judge(choiceContext, Owner, cardPlay.Target, 3);
    }
