...
/// <summary>Gain {Block} Block. A player gains {Block} Block.</summary>
public sealed class Interpose() : PaladinCard(1, CardType.Skill, CardRarity.Common, TargetType.AnyPlayer)
{
