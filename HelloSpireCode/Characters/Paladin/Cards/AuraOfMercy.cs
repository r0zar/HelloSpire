...
/// <summary>Aura: at the start of your turn, heal ALL players 2. Grace, on a schedule.</summary>
public sealed class AuraOfMercy() : PaladinCard(2, CardType.Power, CardRarity.Uncommon, TargetType.Self)
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await PowerCmd.Apply<AuraOfMercyPower>(choiceContext, Owner.Creature,
