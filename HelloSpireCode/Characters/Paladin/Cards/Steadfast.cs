...
/// <summary>Gain {Block} Block. Draw {Cards} {Cards}.</summary>
public sealed class Steadfast() : PaladinCard(0, CardType.Skill, CardRarity.Common, TargetType.Self)
{
    public override bool GainsBlock => true;
    protected override IEnumerable<DynamicVar> CanonicalVars => [new BlockVar(3m, ValueProp.Move), new CardsVar(1)];
