...
/// <summary>Deal damage equal to your Faith in Tyr.</summary>
public sealed class EqualMeasure() : PaladinCard(1, CardType.Attack, CardRarity.Uncommon, TargetType.AnyEnemy)
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await DamageCmd.Attack(FaithTracks.Effective(Owner, Deity.Tyr)).FromCard(this).Targeting(cardPlay.Target).WithHitFx("vfx/vfx_attack_slash").Execute(choiceContext);
    }
