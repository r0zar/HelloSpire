...
/// <summary>Heal 8 plus Spirit. Exhaust. The big self-heal.</summary>
public sealed class Redemption() : PaladinCard(2, CardType.Skill, CardRarity.Uncommon, TargetType.Self)
{
