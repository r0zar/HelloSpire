...
/// <summary>Heal a player to full. Exhaust.</summary>
public sealed class LayOnHands() : PaladinCard(2, CardType.Skill, CardRarity.Rare, TargetType.AnyPlayer)
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await CreatureCmd.Heal(cardPlay.Target!, cardPlay.Target!.MaxHp);
    }
