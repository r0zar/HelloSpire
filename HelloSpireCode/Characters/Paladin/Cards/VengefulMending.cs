...
public sealed class VengefulMending() : PaladinCard(1, CardType.Attack, CardRarity.Common, TargetType.AnyEnemy)
{
    protected override IEnumerable<DynamicVar> CanonicalVars => [new DamageVar(7m, ValueProp.Move), new HealVar(3m)];
    ...
    protected override void OnUpgrade() { DynamicVars["Damage"].UpgradeValueBy(2m); DynamicVars["Heal"].UpgradeValueBy(2m); }
