...
/// <summary>
/// A player gains 3 Plating. Tithe: gain 1 Plating. Prot support that travels -- solo-legal,
/// co-op gift. Renamed from Blessing of Stone; the old Blessing of Protection (1 Buffer)
/// retired so Buffer stays reserved for the true bubble.
/// </summary>
public sealed class BlessingOfProtection() : PaladinCard(1, CardType.Skill, CardRarity.Common, TargetType.AnyPlayer)
{
