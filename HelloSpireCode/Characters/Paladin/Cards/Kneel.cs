...
/// <summary>Gain 1 Faith in your lowest deity. Exhaust.</summary>
public sealed class Kneel() : PaladinCard(0, CardType.Skill, CardRarity.Uncommon, TargetType.Self)
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        FaithTracks.Gain(Owner, FaithTracks.Lowest(Owner), 1);
    }
