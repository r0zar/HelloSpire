...
/// <summary>Gain Block equal to twice your Faith in Torm.</summary>
public sealed class ShieldOfTheRighteous() : PaladinCard(1, CardType.Skill, CardRarity.Rare, TargetType.Self)
{
    ...
    {
        await CreatureCmd.GainBlock(Owner.Creature, 2 * FaithTracks.Effective(Owner, Deity.Torm), ValueProp.Move, cardPlay);
    }
