...
/// <summary>Deal {Damage} damage. Apply {WeakPower} Weak.</summary>
public sealed class Rebuke() : PaladinCard(1, CardType.Attack, CardRarity.Common, TargetType.AnyEnemy)
{
    ...
    protected override void OnUpgrade() { DynamicVars["Damage"].UpgradeValueBy(2m); DynamicVars["WeakPower"].UpgradeValueBy(1m); }
