...
/// <summary>
/// The control Seal: first Attack each turn lowers Strength by 1 for the turn; Judged, apply Amount Weak.
/// </summary>
public sealed class SealOfJusticePower : SealPower
{
    ...
    public override async Task AfterCardPlayed(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        foreach (var target in targets)
            await PowerCmd.Apply<SealOfJusticeShacklesPower>(choiceContext, target, 1m, Owner, null);
    }
