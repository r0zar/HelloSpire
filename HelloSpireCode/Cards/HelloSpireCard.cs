...
namespace HelloSpire.HelloSpireCode.Cards;
...
/// </summary>
[Pool(typeof(HelloSpireCardPool))]
public abstract class HelloSpireCard(int cost, CardType type, CardRarity rarity, TargetType target) :
