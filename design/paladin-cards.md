...
| Word of Glory | 1 | Skill | Heal a player {Heal} HP plus your Spirit. They gain {Strength} Strength. Exhaust. **MP** |
...
| Seal of Command | 1 | Power | Your first Attack each turn applies 1 Vulnerable. Judgment: apply {Amount} Vulnerable. |
| Seal of Justice | 1 | Power | Your first Attack each turn applies 1 Weak. Judgment: apply {Amount} Weak. |
| Seal of Righteousness | 1 | Power | Your Attacks deal {Amount} additional damage. Judgment: deal 5 damage. |
| Seal of Wisdom | 1 | Power | Your first Attack each turn draws a card. Judgment: deal damage equal to your hand size, then draw {Amount}. |
...
Total: 91 cards (25 multiplayer-only). Upgrades live in code; see each card class.
